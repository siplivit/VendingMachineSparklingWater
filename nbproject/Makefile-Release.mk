...
${OBJECTDIR}/src/SettingsManager.o: src/SettingsManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SettingsManager.o src/SettingsManager.cpp
...
${OBJECTDIR}/src/practice/list/listclass.o: src/practice/list/listclass.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/practice/list/listclass.o src/practice/list/listclass.cpp
