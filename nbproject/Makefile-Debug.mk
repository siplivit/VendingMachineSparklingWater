...
${OBJECTDIR}/src/Application/ApplicationManager.o: src/Application/ApplicationManager.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Application/ApplicationManager.o src/Application/ApplicationManager.cpp
...
${OBJECTDIR}/src/Controller/ApplicationController.o: src/Controller/ApplicationController.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Controller/ApplicationController.o src/Controller/ApplicationController.cpp
...
${OBJECTDIR}/src/Types/Types.o: src/Types/Types.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Types/Types.o src/Types/Types.cpp
